...
class EventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post eventos_url, params: { evento: { dataFim: @evento.dataFim, dataInicio: @evento.dataInicio, jogo_id: @evento.jogo_id, nome: @evento.nome } }
    end
  ...
  test "should update evento" do
    patch evento_url(@evento), params: { evento: { dataFim: @evento.dataFim, dataInicio: @evento.dataInicio, jogo_id: @evento.jogo_id, nome: @evento.nome } }
